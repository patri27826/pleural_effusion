...
class MainWindow():
    ...
    def start(self):
        ...
        img = cv2.imread('0001-Echo-1.jpg')
        img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)    
        # mask = img.copy()
        # pixdata = img.load()
        # for y in range(img.size[1]):
        #     for x in range(img.size[0]):
        #         if pixdata[x,y][0] == 170 and pixdata[x,y][1] == 250 and pixdata[x,y][2] == 0:
        #             pixdata[x,y] = (0,0,0,0)
        #         elif pixdata[x,y][0] == 0 and pixdata[x,y][1] == 250 and pixdata[x,y][2] == 0:
        #             pixdata[x,y] = (0,0,0,0)
        #         elif pixdata[x,y][0] == 0 and pixdata[x,y][1] == 250 and pixdata[x,y][2] == 250:
        #             pixdata[x,y] = (0,0,0,0)
    
        ##針對特定的pixel RGB變成白色pixel 其餘轉黑色pixel
        ## mask是要消除的白色遮罩
        mask = img.copy()      
        ...
        #儲存消除完雜訊的影像及mask遮罩
        # img_path = 'C:/Users/CCC/Desktop/tumour_project/data/Echo_0629/20220922_redo/mixed/img_denoising'
        #img_path = 'C:/Users/Jeff/Desktop/tmp/for_report/original_img/'
        #img_path = 'C:/Users/Jeff/Desktop/tmp/for_report/original_label/'
        ...
        cv2.imwrite('processed.bmp',dst1)
        ...
        cropped_image = dst1[y_min:y_max, x_min:x_max]
